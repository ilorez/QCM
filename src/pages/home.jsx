...
function Home() {
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.6061 9.89832L9.60912 9.90129L11.0326 8.49643L2.42348 0L0.999978 1.40486L8.1826 8.49345L0.576477 16L1.99998 17.4049L9.6061 9.89832Z" fill="#808080"/>
    ...
    const paths = [['.././ts/data/level1.json', "Easy"], ['./data/level2.json', "Intermediate"], ['./data/level3.json', "Moderate"], ['./data/level4.json', "Challenging"], ['./data/level5.json', "Very Hard"], ['./data/levelImpossible.json', "Impossible"], ['./data/levelNotSense.json', "Not sens"]]
